    ...
    <div ref={ref} className="space-y-6 text-right">
      ...
      >
        ...
        <p className="text-muted-foreground text-lg leading-relaxed">
          כל יום, מאות ישראלים מחפשים &quot;ביקורות על [העסק שלכם]&quot; בגוגל. רוב העסקים מפסידים את הלקוחות האלה כי אין להם ביקורות ברשת. אבל העסקים החכמים הפכו את החיפושים האלה למכירות אמיתיות.
        </p>
      </motion.div>
