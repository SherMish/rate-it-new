...
export function VisitToolButtonDesktop({
  ...
  return (
    <button
      onClick={handleClick}
      className={`inline-flex items-center justify-center gap-2 px-4 py-3 bg-background text-foreground rounded-md border border-border hover:bg-background/80 transition-colors h-[40px] ${className}`}
    >
      <ExternalLink className="w-5 h-5" />
