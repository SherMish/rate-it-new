            ...
            >
              ...
              >
                ...
                <p className="text-muted-foreground font-medium">
                  בקרב לקוחות שהטמיעו את הווידג&apos;ט של רייט-איט בדף הנחיתה
                  שלהם
                </p>
              </motion.div>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  answer:
                    "עסקים עם ביקורות חיוביות ותג 'מאומת' במסלול Plus מקבלים יותר חשיפה בפלטפורמה, מופיעים גבוה יותר בתוצאות, ומשדרים אמון מיידי. בנוסף, תוכלו לשתף את דף הביקורות שלכם באתר העסק וברשתות החברתיות – ככל שיותר לקוחות יראו, כך יגדל הסיכוי לפניות.",
                },
              ].map((faq, index) => (
                <FAQItem
                  key={index}
