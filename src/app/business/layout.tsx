...
export const metadata: Metadata = {
  title: "פלטפורמת ביקורות לעסקים | ניהול מוניטין דיגיטלי | רייט-איט",
  description: "פלטפורמה לניהול ביקורות עסקיות. הגדילו מכירות ב-43% עם ביקורות חיוביות. הצטרפו ל-300+ עסקים ישראליים והתחילו בחינם.",
  keywords: [
    "פלטפורמת ביקורות",
    "ניהול ביקורות לקוחות",
    "מערכת ביקורות לעסק",
    "ביקורות עסקים ישראל",
    "פלטפורמה לביקורות עסקיות",
    "ניהול מוניטין דיגיטלי",
    "מערכת דירוגים ללקוחות",
    "פלטפורמה לעסקים",
    "ניהול ביקורות",
    "מוניטין דיגיטלי",
    "ביקורות לקוחות",
